...
// Middleware for listing all files
...
// Middleware for checking if the video file exists
function checkVideoFileExists(req: Request, res: Response, next: NextFunction) {
...
// Middleware for deleting a video file
function deleteVideoFile(req: Request, res: Response, next: NextFunction) {
